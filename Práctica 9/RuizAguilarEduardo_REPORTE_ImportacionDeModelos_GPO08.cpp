...
// 2 Modelos 3D que ocuparemos en la casa 
// 
// Código base práctica 9     
// Std. Includes
#include <string>
...
int main( )
{
    ...
    // Load models
    Model ourModel1((char*)"Models/silla2/ModernCafeTable.obj");
    Model ourModel2((char*)"Models/casa_perro/doghouse.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model1 = glm::translate(model1, glm::vec3(2.0f, 0.0f, 0.0f)); // Translate it down a bit so it's at the center of the scene
        ...
        glm::mat4 model2(1);
        //se trasdala conforme x y z
        model2 = glm::translate(model2, glm::vec3(0.0f, 0.0f, 0.0f)); // Translate it down a bit so it's at the center of the scene
        //LO escalamos de la misma forma que la traslación pero mas pequeño
